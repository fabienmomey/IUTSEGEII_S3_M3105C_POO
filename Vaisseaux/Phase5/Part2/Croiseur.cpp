...
/*
Début de la déclaration des méthodes de la classe croiseur
*/
...
void croiseur::afficher()
{
 ...
 //   cout << "Appel de la methode afficher() de la classe fille croiseur" << endl;
    cout << "Le destroyer de type " << m_type << " qui se nomme " << m_nom << " avec pour points de vie restant " << m_points_vie << " ,et pour degats de l'arme laser " << m_degats_arme_laser;
...
/* Fin de la déclaration des méthodes de la classe croiseur */
