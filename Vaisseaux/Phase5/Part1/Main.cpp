...
History:
        ...
        2.0 - 19/12/2016 TD3 Phase 2
                * Modification du programme de duel pour que l'attaquant puisse choisir le type d'attaque à
                effectuer : « basic » ou « special ».
        2.1 - 06/11/2017
...
int main()
{
	...
	do {
		...
		case 'q': // le joueur qui a le croiseur 1 a appuyé le premier
            ...
            if (!type_attaque) croiseur1.attaquer_basic(&escadron1); // utilisation méthode attaquer_basic
            else croiseur1.attaquer_special(&escadron1); // utilisation méthode attaquer_special
		...
		case 'm': // le joueur qui a le vaisseau 2 a appuyé le premier
            ...
            if (!type_attaque) escadron2->attaquer_basic(&croiseur1); // utilisation méthode attaquer_basic
            else escadron2->attaquer_special(&croiseur1); // utilisation méthode attaquer_special
