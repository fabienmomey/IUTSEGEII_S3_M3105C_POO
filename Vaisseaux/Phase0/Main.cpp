...
int main()
{
    ...
    vaisseau vaisseau1 (nom_vaisseau1, pts_vie1, degats1); // utilisation du constructeur de surcharge
    vaisseau vaisseau2 (nom_vaisseau2, pts_vie2, degats2); // utilisation du constructeur de surcharge
