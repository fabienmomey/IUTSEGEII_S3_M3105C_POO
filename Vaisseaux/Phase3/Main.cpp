...
int main()
{
	...
	int pts_vie_c2,degats_laser_c2,nb_tirs_canonsmax_c2,degats_canons_c2;
        ...
        // Vaisseaux de type  croiseur
	string nom_escadron_e1; // nom du vaisseau de type escadron
	int pts_vie_e1,degats_laser_e1;
    ...
    escadron escadron1 (nom_escadron_e1, pts_vie_e1, degats_laser_e1, "Escadron"); // utilisation du constructeur de surcharge
	...
	do {
		...
		case 'q': // le joueur qui a le croiseur 1 a appuyé le premier
            ...
            croiseur1.attaquer_special(&escadron1);
			croiseur1.afficher();
			escadron1.afficher();
			break;
		case 'm': // le joueur qui a le vaisseau 2 a appuyé le premier
			...
			escadron1.attaquer_special(&croiseur1);
			croiseur1.afficher();
			escadron1.afficher();
			break;
		default:
